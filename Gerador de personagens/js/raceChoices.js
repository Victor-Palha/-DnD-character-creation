...
function raceElfChoice(){
    ...
    //img subraces
        let highElfIMG = '<abbr title="Alto Elfo"><img src="img/elf/alto.png" alt="alto elfo" onclick="openModalHighElf()" id="high"/></abbr>'
        let forestElfIMG = '<abbr title="Elfo da Floresta"><img src="img/elf/floresta.png" alt="Elfo da floresta" onclick="openModalForestElf()" id="forest"/></abbr>'
        let drowIMG = '<abbr title="Elfo Negro"><img src="img/elf/Drow.png" alt="Elfo Drow" onclick="openModalDrow()" id="drow"/></abbr>'
...
function raceDwarfChoice(){
    ...
    buttonChoice.innerHTML = '<h1 id="Bt-choice">Você escolheu essa raça!</h1>';
    //img subraces
        let mountainDwarfMG = '<abbr title="Anão da montanha"><img src="img/dwarf/Mont-dwarf.png" alt="anão da montanha" onclick="openModalMountainDwarf()" id="mountain"/></abbr>'
        let hillDwarfIMG = '<abbr title="Anão da colina"><img src="img/dwarf/dwarf-col.png" alt="Anão da colina" onclick="openModalHillDwarf()" id="hill"/></abbr>'
    //dynamic information of subraces
    let sectionMain = document.getElementById('sectionMain');
...
function raceHumanChoice(){
    ...
    buttonChoice.innerHTML = '<h1 id="Bt-choice">Você escolheu essa raça!</h1>';
    //img subraces
        let deafultHumanIMG = '<abbr title="Humano Padrão"><img src="img/human/defaultHuman.png" alt="Humano Padrão" onclick="openModalDefaultHuman()" id="deHu"/></abbr>'
        let varHumanIMG = '<abbr title="Humano Variante"><img src="img/human/humanVariant.png" alt="Humano Variante" onclick="openModalVarHuman()" id="varHu"/></abbr>'
    //dynamic information of subraces
    let sectionMain = document.getElementById('sectionMain');
...
function raceGnomeChoice(){
    ...
    buttonChoice.innerHTML = '<h1 id="Bt-choice">Você escolheu essa raça!</h1>';
    //img subraces
        let forestGnomeIMG = '<abbr title="Gnomo da Floresta"><img src="img/gnome/forestGnome.png" alt="Gnomo da Floresta" onclick="openModalForestGnome()" id="forest"/></abbr>'
        let rockGnomeIMG = '<abbr title="Gnomo das Rochas"><img src="img/gnome/rockGnome.png" alt="Gnomo das Rochas" onclick="openModalRockGnome()" id="rock"/></abbr>'
    //dynamic information of subraces
    let sectionMain = document.getElementById('sectionMain');
...
function raceHalflingChoice(){
    ...
    buttonChoice.innerHTML = '<h1 id="Bt-choice">Você escolheu essa raça!</h1>';
    //img subraces
        let lightHalflingIMG = '<abbr title="Halfling Pés Leves"><img src="img/halfling/pesleves.png" alt="Halfling pés leves" onclick="openModalLightHalfling()" id="light"/></abbr>'
        let robustHalflingIMG = '<abbr title="Halfling Robusto"><img src="img/halfling/robusto.png" alt="Halfling Robusto" onclick="openModalRobustHalfling()" id="robust"/></abbr>'
    //dynamic information of subraces
    let sectionMain = document.getElementById('sectionMain');
